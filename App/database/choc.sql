...
CREATE TABLE `chocolate` (
  ...
  `username` varchar(45) NOT NULL REFERENCES user ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `transaksi` (
  ...
  KEY `user_buy_choco_idx` (`username`) REFERENCES user ON DELETE CASCADE ON UPDATE CASCADE,
  KEY `type_choco_idx` (`idchocolate`),
  CONSTRAINT `type_choco` FOREIGN KEY (`idchocolate`) REFERENCES `chocolate` (`idchocolate`) ON DELETE CASCADE ON UPDATE CASCADE,
